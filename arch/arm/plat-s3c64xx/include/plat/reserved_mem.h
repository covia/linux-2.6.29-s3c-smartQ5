...
#define RESERVED_MEM_CMM		(0 * 1024 * 1024) //SHARED
#define RESERVED_MEM_MFC		(4 * 1024 * 1024) //SHARED
#define RESERVED_PMEM_PICTURE		(2 * 1024 * 1024) //same as MFC
#define RESERVED_PMEM_JPEG		(1 * 1024 * 1024) //SHARED
#define RESERVED_PMEM_PREVIEW		(3 * 1024 * 1024) //SHARED
#define RESERVED_PMEM_RENDER		(4 * 1024 * 1024) //SHARED
#define RESERVED_PMEM_STREAM		(0 * 1024 * 1024) //SHARED
